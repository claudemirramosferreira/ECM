...
Tools.prototype.greaterOrEqual = function (pDataInicial, pDataFinal) {
    ...
    if (moment(pDataInicial, "DD/MM/YYYY").isValid() &&
            moment(pDataFinal, "DD/MM/YYYY").isValid()) {
        if (moment(pDataFinal, "DD/MM/YYYY").diff(moment(pDataInicial, "DD/MM/YYYY")) >= 0) {
            return true;
        } else {
            return false;
        }
...
Tools.prototype.maior = function (pDataInicial, pDataFinal) {
    var dtInicialList = pDataInicial.split("/");
    var dtFinalList = pDataFinal.split("/");
