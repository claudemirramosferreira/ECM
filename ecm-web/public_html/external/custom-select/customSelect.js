(function (angular, undefined) {
    ...
    module.value('customSelectDefaults', {
        displayText: 'Selecione um registro...',
        emptyListText: 'Não existem itens',
        emptySearchResultText: 'Sem resultados para "$0"',
        addText: 'Add',
        searchDelay: 1000
    });
            ...
            return {
                ...
                link: function (scope, elem, attrs, controller) {
					...
					'<div class="dropdown-menu">' +
						...
						'<ul role="menu">' +
                                                        '<li>'+
                                                                '<a role="menuitem" tabindex="-1" href ng-click="select('+ -1  +')">' +
                    ...
                    function getItem(key, collections){
                        var x;
                    ...
                    function setDisplayText() {                        
                            ...
                            if (selectElement) {
                                ...
                                var tmpScope = $(selectElement).scope();
                                var magicVal = false;
                                
                                if(tmpScope){
                                    if(attrs.ngKeyField){
                                        magicVal = eval('tmpScope.'+attrs.ngModel+'.'+attrs.ngKeyField);
                                    }else{
                                        magicVal = eval('tmpScope.'+attrs.ngModel);
                                    }
                                }

                                var index = getItem(magicVal, collection);

                                locals[valueName] = collection[index];
